									...
									<div class="titulo">
										...
										<div class="titulo_der">
											<div class="enlaces">
												<button
													title="Editar"
													class="btnModalEditar item icon-pencil"
													type="button"
													data-plan="${datos.idPlan}"></button>
												<button
													title="Eliminar"
													class="btnEliminar icon-bin"
													data-materia="7729"
						...
						if ( datos.status == true ) {
							...
							titulo.innerHTML = `
								<div class="titulo_izq">
									...
									<div class="titulo_der">
									<div class="enlaces">
										<button title="Editar" class="btnModalEditar item icon-pencil" type="button" data-plan="${formData.get('plan')}"></button>
										<button title="Eliminar" class="btnEliminar icon-bin" data-materia="${formData.get('materia')}" data-plan="${formData.get('plan')}" type="button"></button>
									</div>
								</div>
							`;
